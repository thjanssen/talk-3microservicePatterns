...
public class OutboxUtil {
	...
	public void writeEventToOutbox(PurchaseOrder order, Operation op) throws JsonProcessingException {

        ObjectMapper mapper = new ObjectMapper();

		ObjectNode json = mapper.createObjectNode()
			.put("id", order.getId())
			.put("customer", order.getCustomerName());
	...
	public void writeSagaEventToOutbox(PurchaseOrder order, SagaOperation op) throws JsonProcessingException {
